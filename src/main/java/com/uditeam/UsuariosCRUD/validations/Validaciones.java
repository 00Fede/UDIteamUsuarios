package com.uditeam.UsuariosCRUD.validations;
...
public class Validaciones {
	...
	/**
	 * Valida que el String telefono solo contiene numeros
	 * @param telefono
	 * @return true si el texto solo contiene digitos, falso de los contrario
	 */
	public static boolean isNumber(String telefono){
